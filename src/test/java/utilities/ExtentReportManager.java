...
public class ExtentReportManager implements ITestListener{
	...
	public void onStart(ITestContext testContext){
		...
		sparkReporter.config().setDocumentTitle("AuditGeius Test-Report");
		...
		extent.setSystemInfo("Application Name", "AuditGenius");
